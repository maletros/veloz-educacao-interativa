          ...
          <nav className="hidden md:flex items-center space-x-8">
            {navLinks.map((link) => (
              <div key={link.name} className="relative group">
                ...
                {link.hasSubmenu && (
                  <div className="absolute left-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all">
                    <a href="#" className="block px-4 py-2 text-sm text-veloz-dark hover:bg-veloz-light">
                      Programação
                    </a>
                    <a href="#" className="block px-4 py-2 text-sm text-veloz-dark hover:bg-veloz-light">
                      Empreendedorismo
