...
const LeaderboardPreview = () => {
  return (
    <section className="py-20 bg-white dark:bg-veloz-dark">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <div className="inline-block px-3 py-1 mb-4 text-sm font-medium text-veloz-blue dark:text-white bg-veloz-blue/10 dark:bg-veloz-blue/20 rounded-full">
            Competição Saudável
          </div>
          <h2 className="text-3xl md:text-4xl font-bold text-veloz-dark dark:text-white mb-4">
            Leaderboard
          </h2>
          <p className="text-lg text-veloz-gray dark:text-gray-300 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
          <div className="lg:col-span-2">
            <div className="glass-card rounded-xl overflow-hidden">
              <div className="flex items-center justify-between bg-veloz-blue/5 dark:bg-veloz-blue/20 px-6 py-4">
                <div className="flex items-center">
                  <Users className="w-5 h-5 text-veloz-blue mr-2" />
                  <h3 className="font-medium dark:text-white">Top 5 Estudantes - Semanal</h3>
                </div>
                <div className="flex space-x-1">
                  <button className="px-3 py-1 text-sm bg-veloz-blue text-white rounded-full">Semanal</button>
                  <button className="px-3 py-1 text-sm bg-white dark:bg-veloz-dark/70 text-veloz-dark dark:text-white rounded-full">Mensal</button>
                  <button className="px-3 py-1 text-sm bg-white dark:bg-veloz-dark/70 text-veloz-dark dark:text-white rounded-full">Geral</button>
                </div>
              </div>
              ...
              <div className="divide-y divide-veloz-light dark:divide-veloz-dark/70">
                {leaderboardUsers.map((user, index) => (
                  <div 
                    key={user.id} 
                    className={`flex items-center p-4 ${index === 0 ? 'bg-yellow-50 dark:bg-veloz-blue/30 leaderboard-highlight' : ''}`}
                  >
              ...
              <div className="bg-veloz-blue/5 dark:bg-veloz-blue/20 px-6 py-4 text-center">
                <Button variant="outline" className="border-veloz-blue text-veloz-blue dark:text-white dark:border-white hover:bg-veloz-blue/5 dark:hover:bg-white/10">
          ...
          <div className="glass-card rounded-xl p-6 lg:p-8 text-center">
            <h3 className="text-xl font-bold mb-6 dark:text-white">Conquistas em Destaque</h3>
            ...
            <div className="mb-8">
              <div className="mb-2 flex justify-between items-center">
                <span className="text-sm font-medium dark:text-white">Próximo Nível (15)</span>
                <span className="text-sm text-veloz-gray dark:text-gray-300">2450 / 3000 XP</span>
              </div>
              <div className="w-full h-2 bg-veloz-light dark:bg-veloz-dark/60 rounded-full overflow-hidden">
                <div 
